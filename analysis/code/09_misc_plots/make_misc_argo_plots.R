...
g <- ggplot() +
  ...
  theme(panel.background = element_blank(),
        ...
        legend.title = element_text(size = 13))
g
ggsave(filename = 'analysis/images/misc/profile_locations_large_bw.png', g, height = 4, width = 6)
ggsave(filename = 'analysis/images/misc/profile_locations_bw.png', g, height = 4, width = 6,dpi = 200)
ggsave(filename = 'analysis/images/misc/profile_locations_bw.eps',
       g, height = 4, width = 6)
