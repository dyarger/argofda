...
ohc_fun <- function(x) {
  ...
  # Compute OHC by each discretization scheme
  ...
  # Compute variances over each discritization using delta method
  # Variance
...
# cross - set up matrices on grid of pressures
